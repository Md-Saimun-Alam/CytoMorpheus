# =============================================================================
# CytoMorpheus — Phase Contrast AlexNet-BiLSTM Training
# =============================================================================
...
#                Per-frame features extracted by AlexNet applied via
#                TimeDistributed, temporal dynamics modelled by Bi-LSTM
...
# Result       : 88.35% accuracy | F1-Macro: 87.77% | AUC-Macro: 97.06%
# =============================================================================
...
base_path = "/content/drive/MyDrive/Cell Death/bright field"
...
def build_alexnet_video(input_shape, n_frames, num_classes):
    ...
    Rescaling layer converts [0,1] inputs back to [0,255]
    to match AlexNet's expected input range.
    """
    ...
    return models.Model(video_in, output, name='AlexNetVideo_BiLSTM')
...
save_dir = '/content/drive/MyDrive/Cell Death/Latest Models/Bright/AlexNetVideo'
