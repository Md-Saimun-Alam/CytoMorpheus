# =============================================================================
# CytoMorpheus — Phase Contrast MobileNetV2 Training
# =============================================================================
...
# Result       : 92.09% accuracy | F1-Macro: 91.63% | AUC-Macro: 98.38%
# =============================================================================
...
def build_video_model_mobilenet(input_shape, n_frames, num_classes,
    ...
    Partial fine-tuning: all layers are trainable; layers before
    the last `fine_tune_at` layers are frozen to preserve low-level
    ImageNet features.
    """
...
save_dir = '/content/drive/MyDrive/Cell Death/Latest Models/Bright'
